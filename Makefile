...
SRC = ft_strlcat.c ft_strlen.c ft_bzero.c ft_isalnum.c ft_isalpha.c \
		ft_isascii.c ft_isdigit.c ft_tolower.c ft_isprint.c ft_memcpy.c \
		ft_memmove.c ft_memset.c ft_toupper.c ft_strlcpy.c ft_memchr.c \
		ft_memcmp.c ft_strchr.c ft_strrchr.c ft_atoi.c ft_strncmp.c \
